...
$arrCronLog=[];
$arrCronLog['cron_name']="Daily Partner Booked Update";
...
if($cronId)
{
	...
	try
	{
		if($objZoho->checkTokens())
		{
			...
			$arrRecords[]=$arrData;
			$arrTrigger=["workflow"];
			$json_modules=$objZoho->updateRecord("WF_Triggers","3108913000000407696",$arrRecords,$arrTrigger);
			...
			//mail("jaykishan@qltech.com.au","Cron : Daily Camp Update",$mailbody,$headers);
