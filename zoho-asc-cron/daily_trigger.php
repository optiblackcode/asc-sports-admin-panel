...
$arrCronLog=[];
$arrCronLog['cron_name']="Daily Trigger";
...
if($cronId)
{
	...
	try
	{
		if($objZoho->checkTokens())
		{
			...
			$arrRecords[]=$arrData;
			$arrTrigger=["workflow"];
			$json_modules=$objZoho->updateRecord("WF_Triggers","3108913000000259990",$arrRecords,$arrTrigger);

			//********************** Send mail when cron executed ***************
			$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			$headers .= "From: info@qltech.com.au";
			$mailbody="<h3>Daily Trigger Executed</h3><h5>Date Time (Victoria) : ".$dateTime."</h5>";
			...
			//mail("jaykishan@qltech.com.au","Cron : Daily Trigger",$mailbody,$headers);
		}
	}
	catch(Exception $e)
	{
